...
HD_PWD='C:/Users/cse/final/final.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sevenSegmentCal.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sevenSegmentCal.tcl
